...
class RecoveryBanner extends StatelessWidget {
  ...
  final void Function(RecoveryCandidate candidate, String backupPath)
  onOpenBackup;
          ...
          child: CcDialogShell(
            ...
            sections: [
              ...
              _Choice(
                ...
                subtitle:
                    'Saved ${stamp(candidate.autosaveModified)} · recommended',
              ...
              _Choice(
                ...
                subtitle:
                    'Saved ${stamp(candidate.projectModified)} · discards the autosave',
                      ...
                      children: [
                        for (final backup in backups.take(20))
                          _Choice(
                            ...
                            title:
                                backup.path.split(Platform.pathSeparator).last,
                            subtitle:
                                'Saved ${stamp(backup.statSync().modified)}',
                            dense: true,
