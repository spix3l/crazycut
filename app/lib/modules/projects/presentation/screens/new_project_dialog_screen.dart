...
import 'package:crazycut_app/modules/projects/presentation/widgets/preset_tile.dart';
    ...
    return CcModalBarrier(
      ...
      child: CcDialogShell(
        ...
        sections: [
          ...
          CcField(label: 'Location', child: CcTextField(value: _location)),
        ],
        actions: [
          CcButton(
            label: 'Cancel',
