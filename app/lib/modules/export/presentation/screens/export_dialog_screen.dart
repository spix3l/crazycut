...
import 'package:crazycut_app/modules/export/presentation/widgets/export_preset_tile.dart';
import 'package:crazycut_app/modules/export/presentation/widgets/export_queue_panel.dart';
...
class _ExportDialogScreenState extends State<ExportDialogScreen> {
  ...
  void initState() {
    super.initState();
    _session = AppDependenciesScope.read(context).session;
    _service = AppDependenciesScope.read(context).exports;
  ...
  String _estimate(int width, int height, double seconds) {
    ...
    final fps = _session.project?.settings.fpsValue ?? 30;
