...
import 'package:crazycut_app/modules/project/domain/clip_animation.dart' as clip_anim;
...
part 'clip_keyframe.dart';
part 'clip_keyframe_marker.dart';
part 'clip_timing.dart';
part 'drop_mode.dart';
part 'edit_gesture.dart';
