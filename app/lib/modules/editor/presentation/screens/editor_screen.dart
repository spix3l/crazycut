...
import 'package:crazycut_app/app/router/app_router.gr.dart';
...
import 'package:crazycut_app/modules/editor/presentation/widgets/editor_toolbar.dart';
import 'package:crazycut_app/modules/editor/presentation/widgets/inspector/inspector_panel.dart';
import 'package:crazycut_app/modules/editor/presentation/widgets/media_pool.dart';
import 'package:crazycut_app/modules/editor/presentation/widgets/folder_access_dialog.dart';
import 'package:crazycut_app/modules/editor/presentation/widgets/missing_media_dialog.dart';
import 'package:crazycut_app/modules/editor/presentation/widgets/mixer_panel.dart';
import 'package:crazycut_app/modules/editor/presentation/widgets/monitor_panel.dart';
import 'package:crazycut_app/modules/editor/presentation/widgets/onboarding_checklist.dart';
...
class _EditorScreenState extends State<EditorScreen> {
  ...
  bool _mixer = false;
  late double _pxPerSec;
  double _lanesWidth = 800;

  EditorController? get _controller =>
      _session.hasProject ? _session.editor : null;
  ...
  void initState() {
    ...
    _snap = _dependencies.preferences.timelineSnap;
    _pxPerSec = _dependencies.preferences.timelinePixelsPerSecond;
    unawaited(_dependencies.onboarding.load());
  ...
  Future<void> _checkFolderAccess() async {
    ...
    final blocked = _dependencies.sandbox.blocked(c.doc, c.path);
  ...
  void _setZoom(double t) {
    ...
    _dependencies.preferences.setTimelinePixelsPerSecond(_pxPerSec);
  }

  void _setSnap(bool value) {
    setState(() => _snap = value);
    _dependencies.preferences.setTimelineSnap(value);
  }
  ...
  Future<void> _generateAutoCaptions(EditorController c) async {
    ...
    final model = speechModelById(_dependencies.aiSettings.speechModelId);
    final models = _dependencies.speechModels;
  ...
  void _cancelAutoCaptions(EditorController c) {
    _dependencies.speechModels.cancel();
  ...
  Widget build(BuildContext context) {
    ...
    return ListenableBuilder(
      ...
      listenable: Listenable.merge([
        controller,
        _dependencies.aiSettings,
        _dependencies.onboarding,
        _dependencies.speechModels,
        _dependencies.editor.transcription,
      ]),
                    ...
                    children: [
                      Column(
                        children: [
                          EditorToolbar(
                            ...
                            onFindShorts:
                                _dependencies.aiSettings.configured && !empty
                                    ? () => context.router.push(
                              ...
                              builder: (context, constraints) {
                                ...
                                return TimelinePanel(
                                  ...
                                  modelDownloadProgress:
                                      _dependencies.speechModels.progress,
                                );
                              },
                            ),
                          ),
                      ...
                      Positioned(
                        ...
                        child: OnboardingChecklist(
                          state: _dependencies.onboarding,
                        ),
                      ),
                    ],
                  ),
  ...
  Future<void> _renameProject(EditorController c) async {
    ...
    await c.rename(name);
    await _session.noteRenamed(previous, c.path);
  }
}
