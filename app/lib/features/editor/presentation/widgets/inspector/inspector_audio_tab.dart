      ...
      child: Column(
        ...
        children: [
          ...
          SliderRow(
            ...
            value: (_db(clip.volume) - AudioEdits.kSilenceDb) /
              ...
              children: [
                ...
                CcTooltip(
                  ...
                  child: CcButton(
                    ...
                    onPressed:
                        silent ? null : () => c.normalizeClip(clip.id),
                  ),
                ),
              ],
            ),
          ...
          _CurveRow(
            ...
            labels: _curveLabels,
            onChanged: (i) =>
                c.setFadeCurve(clip.id, fadeIn: true, curve: _curves[i]),
          ),
          TimecodeRow(
            label: 'Fade out',
            ...
            child: CcSegmented(
              ...
              children: [
                for (final l in labels)
                  Text(l, style: CcType.style(size: 11)),
              ],
            ),
          ),
        ],
